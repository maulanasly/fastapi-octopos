...
void main() {
  ...
  group('CheckoutSheet payment flow', () {
    testWidgets('paying pops the created order (regression: Payment parsed as Order)',
        (tester) async {
      ...
      expect(popped, isNotNull, reason: 'checkout must pop the settled order');
...
class _FakeOrders extends OrderRepository {
  _FakeOrders() : super(ApiClient(store: TokenStore(), onSessionExpired: () {}));
